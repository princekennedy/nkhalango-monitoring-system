        ...
        <Guest>
            ...
            >
                <div className="px-10 py-12">
                    ...
                    <div className="mb-4 text-sm text-green-500 leading-normal">
                    ...
                    <div className="py-4 bg-green-100 border-t border-green-200 text-center">
                        <LoadingButton
                            type="submit"
                            loading={processing}
                        ...
                        <Link href={route('login')} className="pt-4 text-sm text-green-600 hover:text-green-900 block">
